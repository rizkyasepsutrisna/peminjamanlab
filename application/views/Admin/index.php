    ...
    <div id="dashboard">
        ...
        <div class="utf_dashboard_navigation js-scrollbar">
            <div class="utf_dashboard_navigation_inner_block">
                <ul>
                    <li class="active"><a href="<?= base_url(); ?>Admin"><i class="sl sl-icon-plus"></i> Tambah Barang</a></li>
                    <li>
                    ...
                    <div id="utf_add_listing_part">
                        <div class="add_utf_listing_section">
                            <div class="utf_add_listing_part_headline_part">
                                <h3><i class="sl sl-icon-note"></i> Tambah Barang</h3>
                            </div>
                            ...
                            <div class="col-md-6">
                                <a href="<?= base_url(); ?>Admin_daftarbarang" class="button preview"><i class="fa fa-arrow-circle-right"></i> Tambah Barang</a>
                            </div>
                        </div>
                    </div>
                </div>
